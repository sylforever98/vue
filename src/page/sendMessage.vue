        ...
        <div class="table_container">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
				<el-form-item label="设备ID">
                    <el-input v-model="formInline.user" placeholder="请输入设备ID"></el-input>
                </el-form-item>
            ...
            <el-table
				...
				<el-table-column
                  ...
                  prop="vrname">
				   <!-- <template slot-scope="scope">
                      <span v-if="scope.row.vrname==9"><img src="../assets/img/charge1.png"   alt="" width="38" ></span>
                      <span v-if="scope.row.vrname==8"><img src="../assets/img/charge2.png"   alt="" width="38" ></span>
                       <span v-if="scope.row.vrname==7"><img src="../assets/img/charge3.png"   alt="" width="38" ></span>
                   </template> -->
                </el-table-column>
                 ...
                 <el-table-column
                  ...
                  prop="namehand">
				   <!-- <template slot-scope="scope">
                      <span v-if="scope.row.namehand==9"><img src="../assets/img/charge1.png"   alt="" width="38" ></span>
                      <span v-if="scope.row.namehand==8"><img src="../assets/img/charge2.png"   alt="" width="38" ></span>
                       <span v-if="scope.row.namehand==7"><img src="../assets/img/charge3.png"   alt="" width="38" ></span>
                   </template> -->
                </el-table-column>
				  <!-- <el-table-column
                prop="category_id"
                ...
                width="180">
                   <template slot-scope="scope"> -->
                      <!-- <span v-if="scope.row.month_sales==0"><span class="fontcred">是</span></span>
                      <span v-if="scope.row.month_sales==1"><span class="fontcgreen">否</span></span> -->
                      <!-- <span v-if="scope.row.category_id==0"><img src="../assets/img/connect1.png"   alt="" width="30" ></span>
                      <span v-if="scope.row.category_id==1"><img src="../assets/img/connect0.png"   alt="" width="30" ></span>
                   </template>
                </el-table-column> -->
                ...
                <el-table-column
                 ...
                 <el-table-column label="操作" width="160">
                  <template slot-scope="scope">
                    <el-button
                      size="small"
                      @click="handleEdit(scope.row)">填写报告</el-button>
                    <!-- <el-button
                      size="small"
                      type="danger"
