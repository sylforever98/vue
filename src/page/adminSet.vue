<template>
    <div class="fillcontain">
        ...
        <el-menu :default-active="defaultActive"  class="el-menu-demo" mode="horizontal"  theme="dark" router>
                <el-menu-item index="adminSet" default-active>班级管理</el-menu-item>
        ...
        <div class="table_container">
            ...
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="选择年级">
                      <el-select v-model="formInline.region" placeholder="一年级">
                    <el-option label="二年级" value="shanghai"></el-option>
                    <el-option label="三年级" value="beijing"></el-option>
                    </el-select>
                    <!-- <el-input v-model="formInline.user" placeholder="审批人"></el-input> -->
                </el-form-item>
                <el-form-item label="选择班级">
                    <el-select v-model="formInline.region" placeholder="一班">
                    <el-option label="二班" value="shanghai"></el-option>
            ...
            <p class="table_topright">Hi，共有班级<span class="fontcred">12</span> 个班级。</p>
            <el-table
                @expand='expand'
                ...
                <el-table-column
                  label="班级人数"
                  prop="namehand">
                   <!-- <el-button @click="handleClick('/shopList')" type="text" size="small">查看</el-button> -->
                </el-table-column>
                 <el-table-column
                  label="备注"
                  prop="month_sales">
            ...
            <el-dialog title="班级信息" v-model="dialogFormVisible">
