...
import async_new from '@/config/fetch'
...
export const adddevice = data => async_new('/api/AddDevice', data, 'POST');
...
export const getFoods = data => async_new('/ReqDevice', data);

/**
 * 获取食品数量
 */

export const getFoodsCount = data => fetch('/ReqDevice', data);
